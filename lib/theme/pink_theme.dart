...
class PinkMaterialTheme implements ITheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onTertiaryContainer: Color(0xff613f20),
      ...
      onSecondaryFixedVariant: Color(0xff5b3f47),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryFixedDim: Color(0xff804056),
      ...
      tertiaryFixedDim: Color(0xff714d2c),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff8c4a60),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff73354b),
      onPrimaryContainer: Color(0xffffffff),
      ...
      inverseSurface: Color(0xff372e30),
      inversePrimary: Color(0xffffb1c8),
      primaryFixed: Color(0xff73354b),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff571f34),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff5d4249),
      onSecondaryFixed: Color(0xffffffff),
      secondaryFixedDim: Color(0xff452c33),
      onSecondaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xfffeabc4),
      onPrimaryContainer: Color(0xff20000c),
      secondary: Color(0xffffebef),
      onSecondary: Color(0xff000000),
      secondaryContainer: Color(0xffdeb9c2),
      ...
      primaryFixedDim: Color(0xffffb1c8),
      onPrimaryFixedVariant: Color(0xff2b0012),
      secondaryFixed: Color(0xffffd9e2),
